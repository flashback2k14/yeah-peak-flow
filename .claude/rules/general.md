...
- Check existing components before building: `git ls-files src/app/shared/` and `git ls-files src/app/features/`
- Check existing APIs before building: `git ls-files backend/src/routes/`
