...
3. Check existing shared components: `ls apps/frontend/src/app/shared/components/ 2>/dev/null`
4. Check existing feature components: `ls apps/frontend/src/app/features/ 2>/dev/null`
5. Check if design decisions already exist in the feature spec
